        ...
        >
          ...
          {openCommandList && (
            ...
            >
              ...
              {/* Bottom scroll fade */}
              <div
                className="pointer-events-none absolute bottom-0 left-0 hidden h-16 w-full bg-linear-to-t from-white sm:block"
...
const CommandInput = forwardRef<HTMLInputElement>((_, ref) => {
  ...
  return (
    <Command.Input
      ...
      disabled={disabled}
      className="block w-full truncate rounded-md border-none px-0 text-base text-gray-900 placeholder-gray-400 outline-hidden outline-0 transition-all duration-300 focus:ring-0 md:text-sm"
      autoCapitalize="none"
    />
  );
});
